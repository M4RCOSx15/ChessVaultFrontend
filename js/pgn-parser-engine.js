...
// https://peggyjs.org/
//
// PATCH (Chess Vault): o arquivo original só sabia se exportar via AMD
// (define) ou CommonJS (module.exports) — nenhum dos dois existe num
// projeto que carrega scripts direto via <script src="...">, sem
// bundler. Adicionamos o branch "else" abaixo para expor a função
// como variável global (window.PgnParserEngine), que é como scripts
// soltos se comunicam entre si nesse projeto.
